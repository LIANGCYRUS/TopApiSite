...
class AlibabaAscpLogisticsSellerSendRequest(BaseRequest):

    def __init__(
        self,
        delivery_mobile: str = None,
        sender_id: int = None,
        feature: str = None,
        tid: str = None,
        sub_tid: str = None,
        ...
        """
            派送员手机号
        """
        self._delivery_mobile = delivery_mobile
        """
    ...
    def delivery_mobile(self, delivery_mobile):
        if isinstance(delivery_mobile, str):
            self._delivery_mobile = delivery_mobile
        else:
            raise TypeError("delivery_mobile must be str")
    ...
    def delivery_name(self, delivery_name):
        if isinstance(delivery_name, str):
            self._delivery_name = delivery_name
        else:
            raise TypeError("delivery_name must be str")
    ...
    def to_dict(self):
        request_dict = {}
        if self._delivery_mobile is not None:
            request_dict["delivery_mobile"] = convert_basic(self._delivery_mobile)
        ...
        if self._delivery_name is not None:
            request_dict["delivery_name"] = convert_basic(self._delivery_name)
