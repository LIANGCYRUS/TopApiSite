...
class TaobaoFenxiaoTradePrepayOfflineAddRequest(BaseRequest):

    def __init__(
        self,
        offline_add_prepay_param: object = None
    ):
        """
            增加流水
        """
        self._offline_add_prepay_param = offline_add_prepay_param

    @property
    def offline_add_prepay_param(self):
        return self._offline_add_prepay_param

    @offline_add_prepay_param.setter
    def offline_add_prepay_param(self, offline_add_prepay_param):
        if isinstance(offline_add_prepay_param, object):
            self._offline_add_prepay_param = offline_add_prepay_param
        else:
            raise TypeError("offline_add_prepay_param must be object")
    ...
    def to_dict(self):
        request_dict = {}
        if self._offline_add_prepay_param is not None:
            request_dict["offline_add_prepay_param"] = convert_struct(self._offline_add_prepay_param)
...
class TaobaoFenxiaoTradePrepayOfflineAddTopOfflineAddPrepayDto:
    def __init__(
        self,
        flow_type: int = None,
