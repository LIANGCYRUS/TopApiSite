...
class TaobaoItemUpdateRequest(BaseRequest):
    ...
    def __init__(
        ...
        """
        self._empty_fields = empty_fields
        """
    ...
    @empty_fields.setter
    def empty_fields(self, empty_fields):
        if isinstance(empty_fields, str):
            self._empty_fields = empty_fields
        else:
            raise TypeError("empty_fields must be str")
    ...
    def to_dict(self):
        ...
        if self._empty_fields is not None:
            request_dict["empty_fields"] = convert_basic(self._empty_fields)
